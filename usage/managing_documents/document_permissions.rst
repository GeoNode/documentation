...
Through the *Share* tab shown in the properties table, it is possible to manage the document share options. it opens a form where set up who can:
...
Once the share options are set, click :guilabel:`Resource` tab and then, from the dropdown menu, select :guilabel:`Save`.
