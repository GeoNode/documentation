...
By default the following commands are exposed: *ping_mngmt_commands_http*, *updatelayers*, *sync_geonode_layers*, *sync_geonode_maps*, *importlayers* and *set_all_layers_metadata*.
