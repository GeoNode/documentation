...
.. warning:: GeoNode master is not compatible with Python < 3.7
...
.. code-block:: shell
  ...
  cd /opt; git clone https://github.com/GeoNode/geonode.git -b master geonode
...
.. warning::
  ...
  GeoNode master is **NOT** compatible with GeoServer < 2.19.x
