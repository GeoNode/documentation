...
An [.env]{.title-ref} file is requird to run the application. It can be created from the [.env.sample]{.title-ref} either manually or with the create-envfile.py script.
