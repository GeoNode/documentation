...
.. code-block:: shell
  ...
  sudo wget --no-check-certificate https://build.geo-solutions.it/geonode/geoserver/latest/data-2.17.1.zip
  sudo unzip data-2.17.1.zip -d /opt/data/
  ...
  sudo wget --no-check-certificate https://build.geo-solutions.it/geonode/geoserver/latest/geoserver-2.17.1.war
  sudo mv geoserver-2.17.1.war /usr/local/apache-tomcat8/webapps/geoserver.war
...
.. code-block:: shell
  ...
  cd /usr/local/tomcat/
  wget --no-check-certificate https://build.geo-solutions.it/geonode/geoserver/latest/geoserver-.2.17.1.war
  mkdir tmp/geoserver
  cd tmp/geoserver/
  unzip /usr/local/tomcat/geoserver-2.17.1.war
  rm -Rf data
...
.. code-block:: shell
  ...
  2f155e5043be        geonode/geoserver:2.17.1   "/usr/local/tomcat/t…"   26 minutes ago      Up 26 minutes       8080/tcp             geoserver4geonode
