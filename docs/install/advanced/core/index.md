...
Be sure you have successfully completed all the steps of the section `install_dep`{.interpreted-text role="ref"}.
...
>
> <figure>
> <img src="img/ubuntu-https-004.png" class="align-center" alt="img/ubuntu-https-004.png" />
