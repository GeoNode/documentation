...
You can open the *Metadata* form of a *Dataset* by clicking the :guilabel:`Edit Metadata` link from the :guilabel:`Edit` options on the *Dataset Page*.
  ...
  .. figure:: img/dataset_metadata_1.png
      :align: center
  ...
  * *Keywords* which are simple keywords for the dataset


  Subsequently, more specialized metadata fields are presented in the metadata form:

  .. figure:: img/dataset_metadata_2.png
      :align: center

  .. figure:: img/dataset_metadata_3.png
      :align: center
  ...
  * *Restrictions* on dataset sharing.
  * *Other constraints*;
